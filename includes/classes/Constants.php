...
class Constants
{
    public static $firstNameCharacters = "Your first name must be between X and XX characters";
    public static $lastNameCharacters = "Your last name must be between X and XX characters";
